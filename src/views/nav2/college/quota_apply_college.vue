    ...
    <section>
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                ...
                <!--</el-form-item>-->
                <el-form-item>
                    <el-button type="primary" @click="handleAdd">申请名额</el-button>
                </el-form-item>
            </el-form>
        </el-col>
        ...
        <el-table :data="tableData" v-loading="listLoading" stripe style="width: 100%">
            ...
            <el-table-column label="申请审核状态" prop="status">
            </el-table-column>
        </el-table>
        <!--工具条-->
    ...
    export default {
        ...
        methods: {
            ...
            getDatas: function () {
                ...
                getQuotaApplyList(para).then((res) => {
